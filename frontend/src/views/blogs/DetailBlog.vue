      ...
      <div class="content">
        <div class="card has-background-light">
                ...
                <div v-else class="media-content">
                  ...
                  <nav class="level">
                    ...
                    <div class="level-right">
                      ...
                      <div v-if="comment.comment_by_id == users.id || users.role == 'admin'" class="level-item">
                        <button
          ...
          <footer class="card-footer">
            ...
            <a v-if="blog.create_by_id == users.id || users.role == 'admin'" class="card-footer-item" @click="deleteBlog">
    ...
    getBlogDetail(blogId) {
      axios
        ...
        .then((response) => {
          ...
          console.log(this.blog.create_by_id)
        })
        .catch((error) => {
